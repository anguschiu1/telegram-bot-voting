...
class QuestionDao{
    ...
    public static function get($id){
        ...
        $stmt = $db->prepare('SELECT user_id, q1, q2, q3, q4, q5, q6, q7, q8, q9, 
            q10, q11, q12, q13, round, ip, create_date, last_modified_date FROM question WHERE user_id = ?');
    ...
    public static function create($obj){
        ...
        $stmt = $db->prepare("INSERT INTO question(user_id, q1, q2, q3, q4, q5, q6, q7, q8, q9, q10, q11, q12, q13, 
        ...
        $stmt->execute(array($obj->user_id, $obj->q1, $obj->q2, $obj->q3, 
            ...
            $obj->q10, $obj->q11, $obj->q12,$obj->q13,  
