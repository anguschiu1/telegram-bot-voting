<?php
    $GLOBALS['WORD_TC'] = array(
        ...
        'SURVEY_Q4' => '你的選民登記屬於那個選區？',
        'SURVEY_Q5' => '假如明天是立法會選舉，你會投票支持以下哪一張名單（名單內名字是現在傳媒盛傳會代表出選的人）？',
        'SURVEY_Q6' => '咁你點睇「%s」係九月四日既勝出機會？',
        'SURVEY_Q7' => '那麼，假設有香港有退選制度，如果你支持既名單退選，你會支持另外既邊張名單？',
        'SURVEY_Q8' => '你揀既係「%1$s」，勝算「%2$s」。若無得揀「%1$s」，則會揀「%3$s」。肯定？',
        'SURVEY_Q9' => '假如明天是立法會選舉，在「區議會（第二）功能組別」（俗稱超區）中，你會投票支持以下哪一位候選人（以下名字是現在傳媒盛傳會代表出選的人）？',
        'SURVEY_Q10' => '咁你點睇「%s」係九月四日既勝出機會？',
        'SURVEY_Q11' => '那麼，假設有香港有退選制度，如果你支持既名單退選，你會支持另外既邊張名單？',
        'SURVEY_Q12' => '10 你揀既係「%1$s」，勝算「%2$s」。若無得揀「%1$s」，則會揀「%3$s」。肯定？',
        'SURVEY_Q13' => '為協助我們分析，我想問多你少少個人資料。請問你係唔係合資格既選民呢？',
        'SURVEY_Q14' => '請問你幾歲？',
        'SURVEY_Q15' => '請問你的職業是什麼類型？',
        'SURVEY_Q14' => '',
        'SURVEY_Q15' => '',
    ...
    $GLOBALS['ANSWER_KEYBOARD_TC'] = array(
        ...
        'Q12' => array('👌 揀定', '🚫 再揀過'),
        'Q13' => array('👌 係',  '🚫 唔係', '❓ 唔清楚'),
        'Q14' => array('18歲以下', '18-25', '26-50', '51-75', '76-98', '唔想講'),
        'Q15' => array('經理及行政人員', '專業人員', '輔助專業人員', '文員', '服務工作及商店銷售人員', '漁農業熟練工人', '手工藝及有關人員', '機台及機器操作員及裝配員', '非技術工人', '學生', '家庭主婦', '不能辨別', '其他(包括失業、巳退休、及其他非在職者)', '唔想講'),
